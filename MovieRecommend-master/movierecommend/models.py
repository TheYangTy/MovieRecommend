...
class Db(models.Model):
    ...
    create_tmp_table_priv = models.CharField(db_column='Create_tmp_table_priv',
...
class Servers(models.Model):
    server_name = models.CharField(db_column='Server_name', primary_key=True,
...
class SlaveMasterInfo(models.Model):
    ...
    ignored_server_ids = models.TextField(db_column='Ignored_server_ids', blank=True,
    ...
    channel_name = models.CharField(db_column='Channel_name', primary_key=True,
                                    max_length=64)  # Field name made lowercase.
...
class SlaveWorkerInfo(models.Model):
    ...
    checkpoint_relay_log_pos = models.BigIntegerField(
    ...
    checkpoint_master_log_pos = models.BigIntegerField(
...
class User(models.Model):
    ...
    event_priv = models.CharField(db_column='Event_priv', max_length=1)  # Field name made lowercase.
    trigger_priv = models.CharField(db_column='Trigger_priv', max_length=1)  # Field name made lowercase.
    create_tablespace_priv = models.CharField(db_column='Create_tablespace_priv',
                                              max_length=1)  # Field name made lowercase.
